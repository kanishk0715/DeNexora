...
export default function FacultyHospitalLogin() {
        ...
        <div className="w-full max-w-md">
          <div className="card p-8">
            <div className="mb-6 text-center">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Faculty & Hospital Portal</h1>
              <p className="mt-2 text-sm text-gray-600">
                FDP, internships, research & recruitment
              </p>
            </div>
