...
const EN: ChatbotCopy = {
  ...
  replies: {
    ...
    ministry:
      'The Ministry of AYUSH supports education, research and practice across Ayurveda, Yoga, Unani, Siddha and Homoeopathy — national institutes, scholarships and skill-bridge programmes.',
    ...
    help: 'I can help with BAMS, internships, jobs, skill assessment, Panchakarma, faculty programmes, portfolios and Ministry of AYUSH schemes. Ask in any of India’s 22 official languages, or English.',
    fallback:
      'I can help with AYUSH education and careers. Try: BAMS course, internships, Panchakarma, or skill assessment.',
  },
};
...
const KEYWORDS: Record<Exclude<ChatTopic, 'fallback'>, string[]> = {
  ...
  ministry: ['ministry', 'ayush', 'आयुष', 'मंत्रालय', 'আয়ুষ', 'ஆயுஷ்', 'ఆయుష్', 'ಆಯುಷ್', 'ആയുഷ്', 'આયુષ', 'آیوش'],
